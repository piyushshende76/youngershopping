...
public class Home_fragment extends Fragment {
    ...
    private SliderLayout imgSlider, banner_slider, featuredslider, payment_banner, payment_banner2;
    ...
    ArrayList<BannerCartModel> models = new ArrayList<>();
    ...
    ArrayList<Child_Home_Model> child_home_models = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tv_slider = (TextView) view.findViewById(R.id.tv_slider);
        ...
        payment_banner = (SliderLayout) view.findViewById(R.id.payment_banner);
        payment_banner2 = (SliderLayout) view.findViewById(R.id.payment_banner2);
        ...
        //DealOf the Day
        rv_deal_of_day2 = (RecyclerView) view.findViewById(R.id.rv_deal2);
        GridLayoutManager gridLayoutManager13 = new GridLayoutManager(getActivity(), 2);
        rv_deal_of_day2.setLayoutManager(gridLayoutManager13);
        rv_deal_of_day2.setItemAnimator(new DefaultItemAnimator());
        rv_deal_of_day2.setNestedScrollingEnabled(false);
        rv_deal_of_day2.addItemDecoration(new GridSpacingItemDecoration(2, dpToPx(1), true));

        //latest spcial
        rv_deal_of_day3 = (RecyclerView) view.findViewById(R.id.rv_deal3);
        GridLayoutManager gridLayoutManager14 = new GridLayoutManager(getActivity(), 2);
        rv_deal_of_day3.setLayoutManager(gridLayoutManager14);
        rv_deal_of_day3.setItemAnimator(new DefaultItemAnimator());
        rv_deal_of_day3.setNestedScrollingEnabled(false);
        rv_deal_of_day3.addItemDecoration(new GridSpacingItemDecoration(2, dpToPx(1), true));

        //bigsale
        rv_deal_of_day4 = (RecyclerView) view.findViewById(R.id.rv_deal4);
        GridLayoutManager gridLayoutManager15 = new GridLayoutManager(getActivity(), 2);
        rv_deal_of_day4.setLayoutManager(gridLayoutManager15);
        rv_deal_of_day4.setItemAnimator(new DefaultItemAnimator());
        rv_deal_of_day4.setNestedScrollingEnabled(false);
        rv_deal_of_day4.addItemDecoration(new GridSpacingItemDecoration(2, dpToPx(1), true));
        ...
        GridLayoutManager layoutManager10 = new GridLayoutManager(getActivity(), 3);
        rv_cat.setLayoutManager(layoutManager10);
        rv_cat.setItemAnimator(new DefaultItemAnimator());
        rv_cat.setNestedScrollingEnabled(false);
        // rv_cat.addItemDecoration(new GridSpacingItemDecoration(2, dpToPx(1), true));

        //make_menu_items Icons
        rv_headre_icons = (RecyclerView) view.findViewById(R.id.collapsing_recycler);
        LinearLayoutManager layoutManager12 = new LinearLayoutManager(getActivity()) {
        ...
        rv_headre_icons.setLayoutManager(layoutManager12);
        ...
        rv_sub_cart = (RecyclerView) view.findViewById(R.id.rv_sub_cart);
        GridLayoutManager gl1 = new GridLayoutManager(getActivity(), 3);
        gl1.setOrientation(LinearLayoutManager.VERTICAL);
        rv_sub_cart.setLayoutManager(gl1);
        rv_sub_cart.setHasFixedSize(true);
        rv_sub_cart.setItemViewCacheSize(10);
        rv_sub_cart.setDrawingCacheEnabled(true);
        rv_sub_cart.setDrawingCacheQuality(View.DRAWING_CACHE_QUALITY_LOW);
...
//                startActivity(sendIntent);
        ...
        rv_categories.addOnItemTouchListener(new RecyclerTouchListener(getActivity(), rv_categories, new RecyclerTouchListener.OnItemClickListener() {
            @Override
    ...
    private void makeCategoriesRequest() {
        ...
        CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.GET,
                BaseURL.GET_CATEGORY2_URL, params, new Response.Listener<JSONObject>() {

            @Override
            public void onResponse(JSONObject response) {
                //Log.d(TAG, response.toString());
                Log.i(TAG, "brand: " + response);
                ...
                try {
                    if (response != null && response.length() > 0) {
                        ...
                        if (status) {
                            ...
                            category_modelList = gson.fromJson(response.getString("brands_banners"), listType);
    ...
    private void makePaymentSliderRequest() {
        JsonArrayRequest req = new JsonArrayRequest(BaseURL.GET_BANNERP_URL,
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            ...
                            for (HashMap<String, String> name : listarray) {
                                ...
                                payment_banner.addSlider(textSliderView);
                                payment_banner2.addSlider(textSliderView);
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            ...
                            for (HashMap<String, String> name : listarray) {
                                ...
                                Log.i(TAG, "onResponse:aaassa "+textSliderView.getDescription());
    ...
    private void makeGetBannerSliderRequest() {
        //offer
        models.clear();
        JsonArrayRequest req = new JsonArrayRequest(BaseURL.GET_CHILD_PRODUCT,
                new Response.Listener<JSONArray>() {
                    @Override
                    public void onResponse(JSONArray response) {
                        //  Log.d(TAG, response.toString());
                        Log.i(TAG, "offer: " + response);
                            ...
                            for (int i = 0; i < response.length(); i++) {
                              ...
                              /*  BannerCartModel bannerCartModel = new BannerCartModel(
                                ...
                                Child_Home_Model child_home_model = new Child_Home_Model(
                                        ...
                                        jsonObject.getString("child_name"),
                                        ""
                                );
                                child_home_models.add(child_home_model);
    ...
    private void makeGetCategoryRequest() {
       ...
       /* if (parent_id != null && parent_id != "") {
        ...
        CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.GET,
                BaseURL.GET_BRAND_URL, params, new Response.Listener<JSONObject>() {
                ...
                try {
                    if (response != null && response.length() > 0) {
                        ...
                        if (status) {
                            ...
                            List<Deal_Of_Day_model> deal_of_day_models = new ArrayList<>();

                            deal_of_day_models = gson.fromJson(response.getString("seller_product"), listType);
                ...
                try {
                    if (response != null && response.length() > 0) {
                        ...
                        if (status) {
                            ...
                            deal_of_day_models = gson.fromJson(response.getString("seller_product"), listType);
                            Deal_OfDay_Adapter deal_ofDay_adapter = new Deal_OfDay_Adapter(deal_of_day_models, getActivity());
                            rv_deal_of_day2.setAdapter(deal_ofDay_adapter);
                            deal_ofDay_adapter.notifyDataSetChanged();
                            if (getActivity() != null) {
                                if (deal_of_day_models.isEmpty()) {
                                    //  Toast.makeText(getActivity(), "No Deal For Day", Toast.LENGTH_SHORT).show();
                                    rv_deal_of_day2.setVisibility(View.GONE);
                                    Deal_Frame_layout.setVisibility(View.GONE);
                                    Deal_Frame_layout1.setVisibility(View.GONE);
                                    Deal_Linear_layout.setVisibility(View.GONE);
                                }
    ...
    private void latest_special() {
       ...
       /* if (parent_id != null && parent_id != "") {
        ...
        CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.GET,
                BaseURL.GET_LATEST_SPECIAL, params, new Response.Listener<JSONObject>() {
                ...
                try {
                    if (response != null && response.length() > 0) {
                        ...
                        if (status) {
                            ...
                            deal_of_day_models = gson.fromJson(response.getString("latest_product"), listType);
                            Deal_OfDay_Adapter deal_ofDay_adapter = new Deal_OfDay_Adapter(deal_of_day_models, getActivity());
                            rv_deal_of_day3.setAdapter(deal_ofDay_adapter);
                            deal_ofDay_adapter.notifyDataSetChanged();
                            if (getActivity() != null) {
                                if (deal_of_day_models.isEmpty()) {
                                    //  Toast.makeText(getActivity(), "No Deal For Day", Toast.LENGTH_SHORT).show();
                                    rv_deal_of_day3.setVisibility(View.GONE);
                                    Deal_Frame_layout.setVisibility(View.GONE);
                                    Deal_Frame_layout1.setVisibility(View.GONE);
                                    Deal_Linear_layout.setVisibility(View.GONE);
                                }
    ...
    private void big_sale() {
        ...
        CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.GET,
                BaseURL.GET_BIG_SALE, params, new Response.Listener<JSONObject>() {


            @Override
            public void onResponse(JSONObject response) {
                //Log.d(TAG, response.toString());
                Log.i(TAG, "steal: " + response);
                ...
                try {
                    if (response != null && response.length() > 0) {
                        ...
                        if (status) {
                            ...
                            List<Top_Selling_model> top_selling_models = new ArrayList<>();

                            top_selling_models = gson.fromJson(response.getString("big_product"), listType);
                            Top_Selling_Adapter top_selling_adapter = new Top_Selling_Adapter(top_selling_models);
                            rv_deal_of_day4.setAdapter(top_selling_adapter);
    ...
    private void make_top_selling() {
        ...
        CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.POST,
                BaseURL.GET_TOP_SELLER, params, new Response.Listener<JSONObject>() {
                ...
                try {
                    if (response != null && response.length() > 0) {
                        ...
                        if (status) {
                            ...
                            top_selling_models = gson.fromJson(response.getString("top_product"), listType);
                            Top_Selling_Adapter top_selling_adapter = new Top_Selling_Adapter(top_selling_models);
                ...
                try {
                    if (response != null && response.length() > 0) {
                        ...
                        if (status) {
                            ...
                            menu_models = gson.fromJson(response.getString("main_categoty"), listType);
