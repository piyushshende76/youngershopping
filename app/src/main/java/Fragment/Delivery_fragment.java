    ...
    private void makeGetAddressRequest(String user_id) {
        ...
        CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.POST,
            ...
            public void onResponse(JSONObject response) {
                Log.i(TAG, "getadd: "+response.toString());
                ...
                try {
                    ...
                    if (status) {
                        ...
                        delivery_address_modelList = gson.fromJson(response.getString("user_detail"), listType);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (type.contentEquals("update")) {
             ...
             //   Double total = Double.parseDouble(db_cart.getTotalAmount()) + Integer.parseInt(deli_charges);
                ...
                tv_total.setText("" + db_cart.getTotalAmount()
                     //   + " + " + deli_charges + " = "  + total+ getActivity().getResources().getString(R.string.currency)
                );
            }
        }
    };
