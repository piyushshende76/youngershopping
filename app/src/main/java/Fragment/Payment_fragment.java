...
import youngershopping.tcc.PaymentGatWay;
import youngershopping.tcc.networkconnectivity.NetworkConnection;
import youngershopping.tcc.networkconnectivity.NetworkError;

import youngershopping.tcc.Paytm;
...
public class Payment_fragment extends Fragment {
    ...
    private void checked() {
        ...
        if (rb_Store.isChecked()) {
            if(checkBox_Wallet.isChecked()){
                Toast.makeText(getActivity(), "store selected", Toast.LENGTH_SHORT).show();
            }else
            {
                attemptOrder();
            }
        ...
        if (rb_Cod.isChecked()) {
            if(checkBox_Wallet.isChecked()){
                Toast.makeText(getActivity(), "home delivery selected", Toast.LENGTH_SHORT).show();
            }else
            {
                attemptOrder();
            }
