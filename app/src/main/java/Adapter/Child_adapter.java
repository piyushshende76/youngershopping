...
public class Child_adapter extends RecyclerView.Adapter<Child_adapter.MyViewHolder> {
    ...
    private List<Child_model> modelList;
...
SharedPreferences preferences;
    ...
    public Child_adapter(List<Child_model> modelList, Context context) {
        this.modelList = modelList;
       // dbcart = new DatabaseHandler(context);
    }

    @Override
    public Child_adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_product_rv, parent, false);
        context = parent.getContext();
        return new Child_adapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(Child_adapter.MyViewHolder holder, int position) {
        Child_model mList = modelList.get(position);
